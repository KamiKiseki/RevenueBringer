...
- **2026-05-15** — Customer referral tracking: `referral_clicks`, `referral_vouchers`, `Lead.client_slug`, `/ref/{slug}` landing + conversion redirect, voucher redeem on client dashboard, proof/admin referral stats (`referral_tracking.py`).
